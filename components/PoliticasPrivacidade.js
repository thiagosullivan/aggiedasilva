  ...
  return (
    <div className={styles.politicas__Container}>
        ...
        <div className="entry-content">
            <p>A sua privacidade é importante para nós. É política do L&amp;SA.COM.BR respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://www.lsausa.com.br" rel="noopener noreferrer">L&amp;SA.COM.BR</a>, e outros sites que possuímos e operamos.</p>
            ...
            <ul>
                ...
                <li>Cookies relacionados a boletins por e-mail
                    <p>Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados &ZeroWidthSpace;&ZeroWidthSpace;para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.</p>
                </li>
            ...
            <ul>
                ...
                <li>O serviço Google AdSense que usamos para veicular publicidade usa um cookie DoubleClick para veicular anúncios mais relevantes em toda a Web e limitar o número de vezes que um determinado anúncio é exibido para você..<br></br>
